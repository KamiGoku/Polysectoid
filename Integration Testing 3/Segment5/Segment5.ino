...
Actuator actuators [3];    // Oscillators 4, 9, 14
...
void setup() {
  ...
  actuators[0].phase = 0.6;
  actuators[1].phase = 0.6;
  actuators[2].phase = 0.6;
